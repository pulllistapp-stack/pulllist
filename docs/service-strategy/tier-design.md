...
### Q1. 스캔 quota — Free 5/일 vs 다른 값?
현재 UI에는 5/일 명시, 백엔드 미강제.

- **옵션 A** — Free 5/일 · Pro 무제한 (현재 안)
- **옵션 B** — Free 10/일 · Pro 무제한 (친구 베타 관대함 유지, 정식 오픈 시 축소 카운트다운)
- **옵션 C** — Free 3/일 · Pro 무제한 (스캔은 Pro 로 대표 기능화)
- **옵션 D** — Free 시간당 1회 rate limit · Pro 무제한 (daily quota 대신 spike 방지)

**추천: A**. 5/일은 커뮤니티가 편안하게 쓸 수치 (박스 오프닝 하나 = 카드 10장, 이틀에 나눠 스캔 감내 가능). Pro의 hook은 무제한 이라기보단 정확도 개선 (OCR pre-pass, hash 캐시) 같은 미래 layer. Claude 비용은 OCR pre-pass (§7) 로 낮춤.
