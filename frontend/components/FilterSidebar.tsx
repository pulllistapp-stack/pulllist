...
/**
 * Classify a rarity into a visual tier — drives both inactive (hint) and
 * active (full color) chip styling. Order matters: more specific matches first.
 */
...
const RARITY_CHIP_INACTIVE: Record<string, string> = {
  common:
...
function rarityChipClass(rarity: string, active: boolean): string {
