...
type Props = {
  ...
  bulkModelReady: boolean;
  bulkModelProgress: { progress: number; totalMB: number } | null;
  bulkModelError: string | null;
      ...
      <main className="flex-1 min-h-0 px-5 flex flex-col items-center justify-start gap-5 relative z-10 overflow-y-auto overscroll-contain">
        ...
        {isBulk && (
          <BulkScanPanel
            ...
            modelReady={bulkModelReady}
            modelProgress={bulkModelProgress}
            modelError={bulkModelError}
            list={bulkList}
            adding={bulkAdding}
            onAdd={onBulkAdd}
