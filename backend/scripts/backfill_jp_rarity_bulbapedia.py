...
JP_SET_TO_BULBAPEDIA: dict[str, str] = {
    ...
    "S1H":   "Shield_(TCG)",
    "S1W":   "Sword_(TCG)",
    # SM-era (S0..S12a predecessors — Sun/Moon)
    "SM0":   "Collection_Sun_(TCG)",
    "SM6":   "Forbidden_Light_(TCG)",
    "SM7":   "Charisma_of_the_Wrecked_Sky_(TCG)",
    "SM8":   "Super_Burst_Impact_(TCG)",
    "SM9":   "Tag_Bolt_(TCG)",
    "SM10":  "Double_Blaze_(TCG)",
    "SM12":  "Alter_Genesis_(TCG)",
    "SM12a": "Tag_All_Stars_(TCG)",
    # XY-era
    "XY2":   "Wild_Blaze_(TCG)",
    "XY3":   "Rising_Fist_(TCG)",
    "XY4":   "Phantom_Gate_(TCG)",
    "XY6":   "Emerald_Break_(TCG)",
    "XY7":   "Bandit_Ring_(TCG)",
    "XY9":   "Rage_of_the_Broken_Heavens_(TCG)",
    "XY10":  "Awakening_Psychic_King_(TCG)",
    # CP-era (Concept Pack)
    "CP1":   "Premium_Champion_Pack_(TCG)",
    "CP2":   "Legendary_Shine_Collection_(TCG)",
    "CP3":   "Pokémon_Kids_TV_(TCG)",
    "CP4":   "Premium_Champion_Pack_EX_x_GX_(TCG)",
    "CP5":   "Mythical_%26_Legendary_Dream_Shine_Collection_(TCG)",
    "CP6":   "20th_Anniversary_(TCG)",
    "SMP2":  "SM-P_Promotional_cards_(TCG)",
    # Black Star Promos (JPP-* in our DB)
